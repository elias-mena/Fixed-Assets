<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteDepartment.aspx.cs" Inherits="FixedAssets.Departmentss.DeleteDeparment" %>
        ...
        <div class="container-fluid">
            ...
            <div class="modal-content">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <label for="TextBoxId" class="sr-only">Id del departmaneto:
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Departmentss/Departments.aspx">Volver</asp:HyperLink>
