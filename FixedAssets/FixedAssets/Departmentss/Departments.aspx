...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <button type="button" class="btn btn-primary m-3">
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Departmentss/EditDepartment.aspx">Editar Departamento</asp:HyperLink>
        </button>

        <button type="button" class="btn btn-danger m-3">
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Departmentss/DeleteDepartment.aspx">Eliminar Departamento</asp:HyperLink>
        </button>
